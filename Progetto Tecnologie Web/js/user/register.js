  ...
  $("form").on("submit", function (e) {
      ...
      if (isvalid_user(Object.fromEntries(formData).username) &&
          ...
          if (password == confpassword) {
              ...
              return $("#content").html($("<p>").text(`Passwords do not match.`));
          }
      } else {
          return $("#content").html($("<p>").text(`Username should be
          alphanumeric and between 3 and 20 characters long. Password should
